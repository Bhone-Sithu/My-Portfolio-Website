...
function page() {
  const links: { label: string; href: string }[] = [
    {
      label: "Axure",
      href: " https://kkdcyt.axshare.com/",
    },
    {
      label: "Documentation",
      href: "https://docs.google.com/document/d/108oK6BIKIZjFtS2-TdM7ognGSAsb7cCF/edit?usp=sharing&ouid=101093057551389131492&rtpof=true&sd=true",
    },
  ];
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center flex flex-col items-center">
            <div className="mx-auto max-w-2xl lg:mx-0">
              <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl font-display">
                UI UX Research Prototype for Skiers
              </h1>
              <p className="mt-6 text-lg leading-8 text-zinc-300">
                This coursework aims to research and develop a mid-fidelity
                prototype for skiers, providing features like activity viewing
                and real-time weather forecasts. We'll integrate design
                theories, conduct empirical research for user feedback, and
      ...
      <article className="px-4 py-12 ">
        <section className="mx-auto w-8/12">
          ...
          <p className=" leading-relaxed my-10">
            As Human Computer Interface final assignment from University, this prototype is created using Figma like tool (Axure) from Microsoft. I have to apply my UI UX knowledge gained through out the subject. The prototype is Google Map integrated, Responsive, Asthetic and User Friendly.
          </p>
        </section>
          ...
          <div className="container flexmin-h-screen px-4 mx-auto">
            <div className="grid w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 mx-auto sm:mt-0  lg:gap-16">
              ...
              <div>
                ...
                <p className="relative mx-auto text-center lg:text-2xl font-medium duration-150 text-zinc-500 group-hover:text-white font-display">
                  Axure from Microsoft <br/>(Figma Like Tool)
                </p>
              </div>
            </div>
          </div>
