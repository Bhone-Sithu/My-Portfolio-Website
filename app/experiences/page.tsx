...
function Experiences() {
  return (
    <>
      <div className="pt-20 bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0">
        <Navigation />
        <div className="container flex justify-center items-center min-h-screen px-4 mx-auto flex-col gap-20">
              ...
              <div className=" flex flex-col items-center">
                ...
                >
                  <ul className="list-disc  flex flex-col gap-2">
                    ...
                    <li>
                      Implemented optimization techniques to enhance
                      performance, SEO, and responsiveness of web applications.
                    </li>
                    <li>
                    ...
                    <li>
                      Utilized Redux for state management, ensuring efficient
                      data flow and maintainability of frontend applications.
                    </li>
                    <li>
          ...
          <div id="CMHL" className="text-white w-11/12 mb-10">
            <Card>
              <span
              ...
              <span className="lg:absolute  mx-auto my-5 flex items-center justify-center lg:w-20 lg:h-20 w-5/12 p-3 text-sm duration-1000 border rounded-full text-zinc-200 group-hover:text-white  border-zinc-500 bg-white group-hover:border-zinc-200 drop-shadow-orange">
                <Image
                ...
                >
                  <ul className="list-disc  flex flex-col gap-2">
                    <li>
                      ...
                      and QA testers to architect and develop the Ferry
                      Management System for the company.
                    </li>
                    <li>
                      Took ownership of managing the frontend server
                      independently and designed APIs tailored for the mobile
                      team's requirements.
                    </li>
                    <li>
                    ...
                    <li>
                      Leveraged a diverse range of technologies including
                      C#.NET, JavaScript, Flutter, EF Core, Azure, Github, and
                      adhered to Scrum practices to ensure efficient project
