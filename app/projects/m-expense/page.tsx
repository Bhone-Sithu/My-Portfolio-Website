...
function page() {
  const links: { label: string; href: string }[] = [
    {
      label: "Github",
      href: " https://github.com/Bhone-Sithu/M-Expense-Android",
    },
  ];
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center flex flex-col items-center">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <p className="mt-6 text-lg leading-8 text-zinc-300">
                We developed an application catering to both hybrid and native
                Android versions, facilitating users in effectively managing
                their expenses for each trip undertaken.
              </p>
            </div>
      ...
      <article className="px-4 py-12 ">
        <section className="mx-auto w-8/12">
          ...
          <p className=" leading-relaxed my-10">
            The goal of this coursework is to develop M-Expense, a mobile
            application tailored for expense management during work trips.
            Designed for employees, the app enables users to efficiently manage
            trip details, including various expense entries associated with each
            trip.
          </p>
        </section>
        ...
        <section id="project-functions" className="">
          <div className="container px-4 my-5 mx-auto">
            <div className="grid grid-cols-1 gap-8 sm:mt-0 lg:gap-8 justify-center items-center">
              <div className="p-10 flex flex-col border rounded-xl bg-zinc-800 w-4/12 mx-auto">
                ...
                <span className="mt-4 text-sm duration-1000 text-zinc-400 group-hover:text-zinc-200">
                  <ul className="flex flex-col  gap-3 list-disc">
                    <li>
                      Users can efficiently create trips and input all necessary
                      information.
                    </li>
                    <li>
                      Expenses can be categorized and added to each trip,
                      facilitating detailed record-keeping.
                    </li>
                    <li>
                      All data is securely stored in the mobile application's
                      SQLite database, with robust search capabilities for easy
                      retrieval.
                    </li>
                    <li>
                      Integration with a cloud-based web database via REST API
                      allows for seamless data synchronization and backup.
                    </li>
                    <li>
                      Mapbox integration enhances user experience by visualizing
                      trip destinations with precise latitude and longitude
                      coordinates on an interactive map.
                    </li>
                  </ul>
                </span>
              </div>
        ...
        <section id="gallery">
          <div className=" w-9/12 grid grid-cols-1 md:grid-cols-2 mx-auto">
            <Image
              alt="Chat Mockup"
              src={"/mocks/m-expense/mexpense.png"}
              width={600}
              height={600}
            />
            ...
            <Image
              ...
              className="border"
              src={"/mocks/m-expense/Mexpensefunctions.png"}
              width={600}
              height={600}
            />
          </div>
